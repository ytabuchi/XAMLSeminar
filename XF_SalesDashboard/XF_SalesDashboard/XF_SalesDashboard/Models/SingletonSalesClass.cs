...
namespace XF_SalesDashboard.Models
{
    public class SingletonSalesClass : INotifyPropertyChanged
    {
        ...
        public List<SummaryModel> GetSalesbyCategories(string area)
        {
            if (_salesData == null) { return new List<SummaryModel>(); }
            return this._salesData
                    .Where(x => x.Area == area)
        ...
        public List<SummaryModel> GetSalesbySegments(string area)
        {
            if (_salesData == null) { return new List<SummaryModel>(); }
            return this._salesData
                .Where(x => x.Area == area)
        ...
        public List<SummaryModel> GetSales(string area)
        {
            if (_salesData == null) { return new List<SummaryModel>(); }
            return this._salesData
                .Where(x => x.Area == area)
        ...
        #region Filtered by Area and Store
        public List<SummaryModel> GetSalesbyCategories(string area, string store)
        {
            if (_salesData == null) { return new List<SummaryModel>(); }
            if (string.IsNullOrEmpty(area))
            {
                return this._salesData
                        .Where(x => x.StoreName == store)
                        .GroupBy(x => x.Category)
                        .Select(x => new SummaryModel
                        {
                            Item = x.Key,
        ...
        public List<SummaryModel> GetSalesbySegments(string area, string store)
        {
            if (_salesData == null) { return new List<SummaryModel>(); }
            if (string.IsNullOrEmpty(area))
            {
